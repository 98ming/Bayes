...
public class Main {
	public static void main(String[] args){
		...
		String originalTrain = "file/adult.data"; //原始数据集
		String processedTrain = "process/adultResult.txt";  // 初始化数据 （数据变换）
		String originalTest = "file/adult1000.test";   // 测试数据，原始1000个
		String originalTest100 = "file/adult100.test"; // 测试数据，原始100个
		String processedTest = "process/adult1000Result.txt"; // 变换后的1000条测试数据
		String processedTest100 = "process/adult100Result.txt"; // // 变换后的100条测试数据
